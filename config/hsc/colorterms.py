...
root.library = {
    ...
    "sdss*": ColortermGroupConfig.fromValues(
        {'g': ColortermConfig.fromValues("g", "r", -0.00816446, -0.08366937, -0.00726883),
         ...
         'NB816': ColortermConfig.fromValues("i", "z",  0.00927133, -0.63558358, -0.05474862),
         'NB921': ColortermConfig.fromValues("z", "i",  0.00752972,  0.09863530, -0.05451118),
         }),
    "ps1*": ColortermGroupConfig.fromValues(
        {'g': ColortermConfig.fromValues("g", "r",  0.00730066,  0.06508481, -0.01510570),
         ...
         'NB816': ColortermConfig.fromValues("i", "z",  0.01191062, -0.68757034, -0.10781564),
         'NB921': ColortermConfig.fromValues("z", "y",  0.00142051, -0.59278367, -0.25059679),
         }),
}
